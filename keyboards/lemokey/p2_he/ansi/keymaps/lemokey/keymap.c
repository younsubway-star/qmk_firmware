...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_ansi_65(
        ...
        KC_LCTL,  KC_LWIN,  KC_LALT,                                KC_SPC,                                 KC_RALT,  MO(FN),             KC_LEFT,  KC_DOWN, KC_RGHT),

    [FN] = LAYOUT_ansi_65(
        KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_DEL,             UG_TOGG,
        ...
        _______,  GU_TOGG,  _______,                                BAT_LVL,                                _______,  _______,            _______,  _______,  _______)
};
